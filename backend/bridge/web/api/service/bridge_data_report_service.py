from web.models import StructureMinuteHistoryData, StructureHourlyHistoryData, Sensor, WeatherDailyHistoryData, Bridge
from web.api.serializer.bridge_data_report_serializer import BridgeDataReportSerializer
...
class BridgeDataReportService:
    serializer_class = BridgeDataReportSerializer
    ...
    def get(self, bid: int):
        ...
        try:
            ...
            last_day_data = self.__get_last_day_data(bid, filtered_features)
            last_hour_data = self.__get_last_hour_data(bid, filtered_features)
    ...
    def __get_last_day_data(self, bid: int, filtered_features: list):
        """
    ...
    def __get_last_hour_data(self, bid: int, filtered_features: list):
        """
